...
#set_property IOB        TRUE     [get_ports rtc_32khz]
#set_property PACKAGE_PIN L16 [get_ports rtc_32khz]
set_property IOB        TRUE     [get_ports rtc_int_n]
set_property PACKAGE_PIN H17 [get_ports rtc_int_n]
...
set_property PACKAGE_PIN G17 [get_ports gps_rxd]
set_property PACKAGE_PIN G18 [get_ports gps_txd]
set_property PACKAGE_PIN G19 [get_ports gps_3dfix]
...
set_property IOB        TRUE     [get_ports temp_int*]
set_property PACKAGE_PIN V15 [get_ports temp_int1_n]
set_property PACKAGE_PIN T17 [get_ports temp_int2_n]

set_property IOSTANDARD LVCMOS33 [get_ports disp*]
set_property DRIVE      8        [get_ports disp*]
set_property IOB        TRUE     [get_ports disp*]
set_property PACKAGE_PIN P14 [get_ports disp_sclk]
set_property PACKAGE_PIN W13 [get_ports disp_blank]
set_property PACKAGE_PIN V12 [get_ports disp_lat]
set_property PACKAGE_PIN U12 [get_ports disp_sin]
set_property PACKAGE_PIN T12 [get_ports disp_status]
